...
const _eras = [
  ...
  _Era(
    ...
    hero: _VideoClip(title: '인터뷰 BLANC', youtubeId: '7GxF4ae4vbQ'),
    subs: [
      _VideoClip(title: '[MAIN] Welcomed, by World', youtubeId: 'L1vaet56r2U'),
      _VideoClip(title: '[C-1] Cyberpunk is Simplebomb', youtubeId: 'UAOV2eLS8E8'),
      _VideoClip(title: '[C-2] Robots & Emotions', youtubeId: 'lWTuIR2fvWo'),
      _VideoClip(title: '[C-3] 8Bit Appearance', youtubeId: 'sIXYfoVtrbY'),
      _VideoClip(title: '[C-4] 8Bit Logging in', youtubeId: 'GrYEi4pQvNg'),
      _VideoClip(title: '[C-5] Somebody is Watching You', youtubeId: 'CGVvcWqbiN0'),
      _VideoClip(title: '[C-6] Draftsman', youtubeId: 'K6AIH9daD6A'),
      _VideoClip(title: '[C-7] Re-fused', youtubeId: '6J05dyuNpdI'),
      _VideoClip(title: '[C-8] Target Locked', youtubeId: 'k_0N5KN258o'),
      _VideoClip(title: '[A-1] Search for it', youtubeId: '4FQduBI7158'),
      _VideoClip(title: '[A-2] Blanc Always Shines', youtubeId: 'Lqlkg1LCiUE'),
      _VideoClip(title: '[A-3] The Cubes of Character', youtubeId: '4brmEBZ3fCg'),
      _VideoClip(title: '[A-4] The Way You See', youtubeId: 'KHd25it2qeA'),
      _VideoClip(title: '[A-5] Oppression', youtubeId: 'Wp9tyFH5DSg'),
      _VideoClip(title: '[A-7] LetterQuakes_2', youtubeId: 'eGE-3o5rVNY'),
      _VideoClip(title: '인터뷰Blanc', youtubeId: '1EeuBWSunt0'),
    ],
  ),
  _Era(
    year: '2023',
